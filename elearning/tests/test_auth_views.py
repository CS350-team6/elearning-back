...
# App imports
from ..views.user_view import CustomTokenObtainPairView, User
...
class LoginTestCase(TestCase):
    def setUp(self):
        ...
        self.view1 = CustomTokenObtainPairView.as_view()
        self.view2 = User.as_view()
    ...
    def test_user_can_log_into_site_with_username(self):
        post_request_data = {'username': self.username, 'password': self.password}
        ...
        request2 = self.factory.get('/api/users/', HTTP_AUTHORIZATION=auth_header_value)
    ...
    def test_user_can_log_into_site_with_uppercase_username(self):
        post_request_data = {'username': self.username.upper(), 'password': self.password}
    ...
    def test_user_can_log_into_site_with_email_adress(self):
        post_request_data = {'username': self.email_address, 'password': self.password}
    ...
    def test_user_can_log_into_site_with_uppercase_email_adress(self):
        post_request_data = {'username': self.email_address.upper(), 'password': self.password}
